...
import sys 
sys.path.append('c:\\Users\\ymatytsin\\Desktop\\Introduction Python (Hillel)\\Introduction_Python_Hillel\\dz_15\\')
...
class StudentTest:
    ...
    __slots__ = ('__test_name', '__test_age', '__test_grade', 'test_student', 'teacher')
    ...
    def __StudentTestSetUp(self):
        ...
        self.test_student = Student(self.__test_name, self.__test_age, self.__test_grade, self.teacher)
